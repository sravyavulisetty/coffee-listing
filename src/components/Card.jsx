  ...
  return (
    <div className='flex flex-row flex-wrap p-4'>
      ...
      <div className='flex flex-row justify-between pt-4'>
        <p className='text-white font-semibold font-font1'>{name}</p>
        <p className='bg-[#BEE3CC] text-black rounded-md p-1 text-xs font-font4 font-semibold'>{price}</p>
      </div>
      ...
      {rating!==null ? 
        ...
        {votes>0 ?
        <p className='text-[#6F757C] pl-1 text-sm font-semibold font-font3'>({votes} votes)</p>
        :
        <p className='text-[#6F757C] pl-1 text-sm font-semibold'></p>
        }
        {!available ? <p className='text-[#ED735D] font-semibold text-sm pl-16'>Sold Out</p>:""}
      </div>
    </div>
    </div>
  )
